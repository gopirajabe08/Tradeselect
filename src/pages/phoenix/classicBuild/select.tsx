...
import { getPhoenixClassicBuilders } from '@/services/api';
...
export default function Page() {
  ...
  useEffect(() => {
    let mounted = true;
    (async () => {
      try { const f = await getPhoenixClassicBuilders(); if (mounted) setFilters(f); }
      catch { /* fall through */ }
    ...
    <div>
      <Card style={{ marginBottom: 16 }}>
        <Row gutter={16} align="middle">
          <Col flex="auto">
            <Title level={3} style={{ margin: 0, color: '#213654' }}>Phoenix Classic</Title>
            <Text type="secondary">Configure classic builder</Text>
          </Col>
          <Col>
